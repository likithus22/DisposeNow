...
function Login(props) {
    ...
    const handelSubmit = async (e) => {
        ...
        const response = await fetch("http://20.204.10.248:5000/api/auth/usr/login", {
                ...
                <div className="col-md-6 offset-md-3">
                    <form onSubmit={handelSubmit} >
                        <div className="mb-2">
                            ...
                            <input type="luemail" className="form-control" id="luemail" aria-describedby="emailHelp" name="email" value={conditionals.email} onChange={onChange} />
                            <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="lupassword" className="form-label">Password</label>
                            <input type="password" className="form-control" id="lupassword" name="password" value={conditionals.password} onChange={onChange} />
                        </div>
